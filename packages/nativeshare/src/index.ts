...
export { shareToQQ, shareToQZone, shareToWeibo4Web, shareToQZone4Web } from './specifyShare';
export {
  Share,
  QQMobileBrowser,
  UCIosBrowser,
...
export type NativeShareConstructor = typeof Others;

let NativeShare: NativeShareConstructor;
